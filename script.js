...
function updateCartTotal() {
    ...
    for (var i = 0; i < cartRows.length; i++) {
        ...
        var priceString = priceElement.innerText.replace(/,/g, '');
        var price = parseFloat(priceString.replace('₱', '')); // Replace '₱' with the actual currency symbol for Philippine Peso
    ...
    // Format the total with commas for thousands and ensure two decimal places
